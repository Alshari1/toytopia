                            ...
                            <div className="max-w-md lg:py-20 mx-auto lg:mr-0">
                                ...
                                <form>
                                    <div className="mb-6">
                                        ...
                                        <input className="w-full py-3 px-4 text-sm text-gray-900 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-none rounded-lg" type="text" placeholder="Stefano Bojarski" id="name" />
                                    </div>
                                    <div className="mb-6">
                                    ...
                                    <span className="text-xs font-semibold text-gray-900">
                                        ...
                                        <Link to='/signin' className="inline-block ml-1 text-orange-900 hover:text-orange-700" href="#">Sign in</Link>
                                    </span>
                                </form>
                            </div>
                        </div>
